...
{
	// printk("gsy rk_vibrator_off ENTER\n");
...
static void rk_vibrator_enable(struct timed_output_dev *sdev, int value)
{
	...
	// printk("gsy rk_vibrator_enable ENTER\n");
...
{
	// printk("gsy rk_vibrator_get_time ENTER\n");
...
{
	// printk("gsy rk_vibrator_timer_func ENTER\n");
...
{
	// printk("gsy rk_vibrator_work ENTER\n");
	rk_vibrator_off();
}
...
static int vibrator_probe(struct platform_device *pdev)
{
	...
	// printk("gsy vibrator_probe ENTER\n");
